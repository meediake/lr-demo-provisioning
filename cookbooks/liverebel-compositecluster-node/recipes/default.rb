...
mysql_database "answers_java" do
  connection mysql_connection_info
  action :create
end

mysql_database_user "answers_java" do
  connection mysql_connection_info
...
mysql_database_user "answers_java" do
  connection mysql_connection_info
  password node["mysql"]["server_user_password"]
  database_name "answers_java"
  host "%"
  privileges [:all]
  action :grant
end

mysql_database "answers_php" do
  connection mysql_connection_info
  action :create
end

mysql_database_user "answers_php" do
  connection mysql_connection_info
  password node["mysql"]["server_user_password"]
  action :create
end
